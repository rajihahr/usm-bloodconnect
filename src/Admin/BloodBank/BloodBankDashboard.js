...
const bloodTypes = [
  {
    ...
    quantity: 53,
    iconSrc:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/df74991bd00685ce355fc178401b48d527bfb781b20af75db78bc86e49683bce?placeholderIfAbsent=true&apiKey=dc1dfaeed34d4c05a46eb3603635944e",
  },
  {
    type: "B+",
    quantity: 18,
    iconSrc:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/61bb7519bf47e08377d6c60adb85dc82c806f631b28e489e2cb9aca45c20ded1?placeholderIfAbsent=true&apiKey=dc1dfaeed34d4c05a46eb3603635944e",
  },
  {
    type: "AB+",
    quantity: 38,
      ...
      <div className={styles.authContainer}>
        <section className={styles.bloodBankContainer}>
          ...
          <div className={styles.analyticsChartContainer}>
            <BloodTypeBarChart bloodTypes={bloodTypes} />
          </div>
